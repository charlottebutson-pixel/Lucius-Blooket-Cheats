(async () => {
    ...
    if (console.log("%c Lucius' Blooket Mod Menu / Cheats %c\n	Made & Modified By: EyeCantSee (Or Lucius Bruce Butson)", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	Lucius' Blooket GUI.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star The Github Repo!%c  https://github.com/charlottebutson-pixel/Lucius-Blooket-Cheats", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
